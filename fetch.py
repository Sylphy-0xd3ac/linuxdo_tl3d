...
def fetch(offset):
    r = subprocess.run(
        [
            ...
            "-H",
            "User-Agent: Mozilla/5.0 (Macintosh; Intel MacOS X 10_15_7) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/26.5 Safari/605.1.15",
        ],
        capture_output=True,
        text=True,
    )
...
if date_override:
    ...
    today = datetime.combine(
        _date.fromisoformat(date_override), datetime.min.time()
